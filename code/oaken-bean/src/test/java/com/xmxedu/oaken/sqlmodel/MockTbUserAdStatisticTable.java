...
public class MockTbUserAdStatisticTable extends TbUserAdStatisticTable.Implementation
{
    public static class Row extends TbUserAdStatisticTable.Row
    {
    ...
    public TbUserAdStatisticTable.Row getRow_return = null;
    public List getRow_returns = new ArrayList(); // use this instead of getRow_return for multiple calls

    public TbUserAdStatisticTable.Row getRow(Connection con, long id)
    {
        getRow_con = con;
        getRow_id = id;
        TbUserAdStatisticTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
            returnVal = (TbUserAdStatisticTable.Row)getRow_returns.get(getRow_calls);
        }
        getRow_calls++;
        return returnVal;
    }

    public TbUserAdStatisticTable.Row getRow(long id)
    {
        getRow_id = id;
        TbUserAdStatisticTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
    ...
    public TbUserAdStatisticTable.Row getRow()
    {
        TbUserAdStatisticTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
    ...
    public TbUserAdStatisticTable.Row getRow(Connection con, String column, String searchText) throws SQLException
    {
        getRow_con = con;
    ...
    public TbUserAdStatisticTable.Row getRow(String column, String searchText) throws SQLException
    {
        getRow_column = column;
        getRow_searchText = searchText;
        TbUserAdStatisticTable.Row returnVal = getRow_return;
    ...
    public TbUserAdStatisticTable.Row[] getRows_return = null;
    public List getRows_returns = new ArrayList(); // use this instead of getRows_return for multiple calls

    public TbUserAdStatisticTable.Row[] getRows(Connection con, String column, String searchText) throws SQLException
    {
        getRows_con = con;
        getRows_column = column;
        getRows_searchText = searchText;
        TbUserAdStatisticTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
        {
            returnVal = (TbUserAdStatisticTable.Row[])getRows_returns.get(getRows_calls);
        }
        getRows_calls++;
        return returnVal;
    }

    public TbUserAdStatisticTable.Row[] getRows(String column, String searchText) throws SQLException
    {
        getRows_column = column;
        getRows_searchText = searchText;
        TbUserAdStatisticTable.Row[] returnVal = getRows_return;
    ...
    public TbUserAdStatisticTable.Row[] getRows(Connection con, String whereClause) throws SQLException
    {
        getRows_con = con;
    ...
    public TbUserAdStatisticTable.Row[] getRows(String whereClause) throws SQLException
    {
        getRows_whereClause = whereClause;
        TbUserAdStatisticTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
    ...
    public TbUserAdStatisticTable.Row[] getAllRows_return = null;
    public List getAllRows_returns = new ArrayList(); // use this instead of getAllRows_return for multiple calls

    public TbUserAdStatisticTable.Row[] getAllRows(Connection con) throws SQLException
    {
        getAllRows_con = con;
        TbUserAdStatisticTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
            returnVal = (TbUserAdStatisticTable.Row[])getAllRows_returns.get(getAllRows_calls);
        }
        getAllRows_calls++;
        return returnVal;
    }

    public TbUserAdStatisticTable.Row[] getAllRows() throws SQLException
    {
        TbUserAdStatisticTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
