...
public class MockTbPaymentplatformTable extends TbPaymentplatformTable.Implementation
{
    public static class Row extends TbPaymentplatformTable.Row
    {
    ...
    public TbPaymentplatformTable.Row getRow_return = null;
    public List getRow_returns = new ArrayList(); // use this instead of getRow_return for multiple calls

    public TbPaymentplatformTable.Row getRow(Connection con, long id)
    {
        getRow_con = con;
        getRow_id = id;
        TbPaymentplatformTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
            returnVal = (TbPaymentplatformTable.Row)getRow_returns.get(getRow_calls);
        }
        getRow_calls++;
        return returnVal;
    }

    public TbPaymentplatformTable.Row getRow(long id)
    {
        getRow_id = id;
        TbPaymentplatformTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
    ...
    public TbPaymentplatformTable.Row getRow()
    {
        TbPaymentplatformTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
    ...
    public TbPaymentplatformTable.Row getRow(Connection con, String column, String searchText) throws SQLException
    {
        getRow_con = con;
    ...
    public TbPaymentplatformTable.Row getRow(String column, String searchText) throws SQLException
    {
        getRow_column = column;
        getRow_searchText = searchText;
        TbPaymentplatformTable.Row returnVal = getRow_return;
    ...
    public TbPaymentplatformTable.Row[] getRows_return = null;
    public List getRows_returns = new ArrayList(); // use this instead of getRows_return for multiple calls

    public TbPaymentplatformTable.Row[] getRows(Connection con, String column, String searchText) throws SQLException
    {
        getRows_con = con;
        getRows_column = column;
        getRows_searchText = searchText;
        TbPaymentplatformTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
        {
            returnVal = (TbPaymentplatformTable.Row[])getRows_returns.get(getRows_calls);
        }
        getRows_calls++;
        return returnVal;
    }

    public TbPaymentplatformTable.Row[] getRows(String column, String searchText) throws SQLException
    {
        getRows_column = column;
        getRows_searchText = searchText;
        TbPaymentplatformTable.Row[] returnVal = getRows_return;
    ...
    public TbPaymentplatformTable.Row[] getRows(Connection con, String whereClause) throws SQLException
    {
        getRows_con = con;
    ...
    public TbPaymentplatformTable.Row[] getRows(String whereClause) throws SQLException
    {
        getRows_whereClause = whereClause;
        TbPaymentplatformTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
    ...
    public TbPaymentplatformTable.Row[] getAllRows_return = null;
    public List getAllRows_returns = new ArrayList(); // use this instead of getAllRows_return for multiple calls

    public TbPaymentplatformTable.Row[] getAllRows(Connection con) throws SQLException
    {
        getAllRows_con = con;
        TbPaymentplatformTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
            returnVal = (TbPaymentplatformTable.Row[])getAllRows_returns.get(getAllRows_calls);
        }
        getAllRows_calls++;
        return returnVal;
    }

    public TbPaymentplatformTable.Row[] getAllRows() throws SQLException
    {
        TbPaymentplatformTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
