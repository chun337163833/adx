...
public class MockTbBizAppAdTable extends TbBizAppAdTable.Implementation
{
    public static class Row extends TbBizAppAdTable.Row
    {
    ...
    public TbBizAppAdTable.Row getRow_return = null;
    public List getRow_returns = new ArrayList(); // use this instead of getRow_return for multiple calls

    public TbBizAppAdTable.Row getRow(Connection con, long id)
    {
        getRow_con = con;
        getRow_id = id;
        TbBizAppAdTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
            returnVal = (TbBizAppAdTable.Row)getRow_returns.get(getRow_calls);
        }
        getRow_calls++;
        return returnVal;
    }

    public TbBizAppAdTable.Row getRow(long id)
    {
        getRow_id = id;
        TbBizAppAdTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
    ...
    public TbBizAppAdTable.Row getRow()
    {
        TbBizAppAdTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
    ...
    public TbBizAppAdTable.Row getRow(Connection con, String column, String searchText) throws SQLException
    {
        getRow_con = con;
    ...
    public TbBizAppAdTable.Row getRow(String column, String searchText) throws SQLException
    {
        getRow_column = column;
        getRow_searchText = searchText;
        TbBizAppAdTable.Row returnVal = getRow_return;
    ...
    public TbBizAppAdTable.Row[] getRows_return = null;
    public List getRows_returns = new ArrayList(); // use this instead of getRows_return for multiple calls

    public TbBizAppAdTable.Row[] getRows(Connection con, String column, String searchText) throws SQLException
    {
        getRows_con = con;
        getRows_column = column;
        getRows_searchText = searchText;
        TbBizAppAdTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
        {
            returnVal = (TbBizAppAdTable.Row[])getRows_returns.get(getRows_calls);
        }
        getRows_calls++;
        return returnVal;
    }

    public TbBizAppAdTable.Row[] getRows(String column, String searchText) throws SQLException
    {
        getRows_column = column;
        getRows_searchText = searchText;
        TbBizAppAdTable.Row[] returnVal = getRows_return;
    ...
    public TbBizAppAdTable.Row[] getRows(Connection con, String whereClause) throws SQLException
    {
        getRows_con = con;
    ...
    public TbBizAppAdTable.Row[] getRows(String whereClause) throws SQLException
    {
        getRows_whereClause = whereClause;
        TbBizAppAdTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
    ...
    public TbBizAppAdTable.Row[] getAllRows_return = null;
    public List getAllRows_returns = new ArrayList(); // use this instead of getAllRows_return for multiple calls

    public TbBizAppAdTable.Row[] getAllRows(Connection con) throws SQLException
    {
        getAllRows_con = con;
        TbBizAppAdTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
            returnVal = (TbBizAppAdTable.Row[])getAllRows_returns.get(getAllRows_calls);
        }
        getAllRows_calls++;
        return returnVal;
    }

    public TbBizAppAdTable.Row[] getAllRows() throws SQLException
    {
        TbBizAppAdTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
