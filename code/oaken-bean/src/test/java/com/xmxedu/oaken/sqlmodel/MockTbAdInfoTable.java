...
public class MockTbAdInfoTable extends TbAdInfoTable.Implementation
{
    public static class Row extends TbAdInfoTable.Row
    {
    ...
    public TbAdInfoTable.Row getRow_return = null;
    public List getRow_returns = new ArrayList(); // use this instead of getRow_return for multiple calls

    public TbAdInfoTable.Row getRow(Connection con, long id)
    {
        getRow_con = con;
        getRow_id = id;
        TbAdInfoTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
            returnVal = (TbAdInfoTable.Row)getRow_returns.get(getRow_calls);
        }
        getRow_calls++;
        return returnVal;
    }

    public TbAdInfoTable.Row getRow(long id)
    {
        getRow_id = id;
        TbAdInfoTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
    ...
    public TbAdInfoTable.Row getRow()
    {
        TbAdInfoTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
    ...
    public TbAdInfoTable.Row getRow(Connection con, String column, String searchText) throws SQLException
    {
        getRow_con = con;
    ...
    public TbAdInfoTable.Row getRow(String column, String searchText) throws SQLException
    {
        getRow_column = column;
        getRow_searchText = searchText;
        TbAdInfoTable.Row returnVal = getRow_return;
    ...
    public TbAdInfoTable.Row[] getRows_return = null;
    public List getRows_returns = new ArrayList(); // use this instead of getRows_return for multiple calls

    public TbAdInfoTable.Row[] getRows(Connection con, String column, String searchText) throws SQLException
    {
        getRows_con = con;
        getRows_column = column;
        getRows_searchText = searchText;
        TbAdInfoTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
        {
            returnVal = (TbAdInfoTable.Row[])getRows_returns.get(getRows_calls);
        }
        getRows_calls++;
        return returnVal;
    }

    public TbAdInfoTable.Row[] getRows(String column, String searchText) throws SQLException
    {
        getRows_column = column;
        getRows_searchText = searchText;
        TbAdInfoTable.Row[] returnVal = getRows_return;
    ...
    public TbAdInfoTable.Row[] getRows(Connection con, String whereClause) throws SQLException
    {
        getRows_con = con;
    ...
    public TbAdInfoTable.Row[] getRows(String whereClause) throws SQLException
    {
        getRows_whereClause = whereClause;
        TbAdInfoTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
    ...
    public TbAdInfoTable.Row[] getAllRows_return = null;
    public List getAllRows_returns = new ArrayList(); // use this instead of getAllRows_return for multiple calls

    public TbAdInfoTable.Row[] getAllRows(Connection con) throws SQLException
    {
        getAllRows_con = con;
        TbAdInfoTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
            returnVal = (TbAdInfoTable.Row[])getAllRows_returns.get(getAllRows_calls);
        }
        getAllRows_calls++;
        return returnVal;
    }

    public TbAdInfoTable.Row[] getAllRows() throws SQLException
    {
        TbAdInfoTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
