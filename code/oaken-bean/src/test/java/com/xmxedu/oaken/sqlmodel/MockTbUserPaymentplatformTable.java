...
public class MockTbUserPaymentplatformTable extends TbUserPaymentplatformTable.Implementation
{
    public static class Row extends TbUserPaymentplatformTable.Row
    {
    ...
    public TbUserPaymentplatformTable.Row getRow_return = null;
    public List getRow_returns = new ArrayList(); // use this instead of getRow_return for multiple calls

    public TbUserPaymentplatformTable.Row getRow(Connection con, long id)
    {
        getRow_con = con;
        getRow_id = id;
        TbUserPaymentplatformTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
            returnVal = (TbUserPaymentplatformTable.Row)getRow_returns.get(getRow_calls);
        }
        getRow_calls++;
        return returnVal;
    }

    public TbUserPaymentplatformTable.Row getRow(long id)
    {
        getRow_id = id;
        TbUserPaymentplatformTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
    ...
    public TbUserPaymentplatformTable.Row getRow()
    {
        TbUserPaymentplatformTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
    ...
    public TbUserPaymentplatformTable.Row getRow(Connection con, String column, String searchText) throws SQLException
    {
        getRow_con = con;
    ...
    public TbUserPaymentplatformTable.Row getRow(String column, String searchText) throws SQLException
    {
        getRow_column = column;
        getRow_searchText = searchText;
        TbUserPaymentplatformTable.Row returnVal = getRow_return;
    ...
    public TbUserPaymentplatformTable.Row[] getRows_return = null;
    public List getRows_returns = new ArrayList(); // use this instead of getRows_return for multiple calls

    public TbUserPaymentplatformTable.Row[] getRows(Connection con, String column, String searchText) throws SQLException
    {
        getRows_con = con;
        getRows_column = column;
        getRows_searchText = searchText;
        TbUserPaymentplatformTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
        {
            returnVal = (TbUserPaymentplatformTable.Row[])getRows_returns.get(getRows_calls);
        }
        getRows_calls++;
        return returnVal;
    }

    public TbUserPaymentplatformTable.Row[] getRows(String column, String searchText) throws SQLException
    {
        getRows_column = column;
        getRows_searchText = searchText;
        TbUserPaymentplatformTable.Row[] returnVal = getRows_return;
    ...
    public TbUserPaymentplatformTable.Row[] getRows(Connection con, String whereClause) throws SQLException
    {
        getRows_con = con;
    ...
    public TbUserPaymentplatformTable.Row[] getRows(String whereClause) throws SQLException
    {
        getRows_whereClause = whereClause;
        TbUserPaymentplatformTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
    ...
    public TbUserPaymentplatformTable.Row[] getAllRows_return = null;
    public List getAllRows_returns = new ArrayList(); // use this instead of getAllRows_return for multiple calls

    public TbUserPaymentplatformTable.Row[] getAllRows(Connection con) throws SQLException
    {
        getAllRows_con = con;
        TbUserPaymentplatformTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
            returnVal = (TbUserPaymentplatformTable.Row[])getAllRows_returns.get(getAllRows_calls);
        }
        getAllRows_calls++;
        return returnVal;
    }

    public TbUserPaymentplatformTable.Row[] getAllRows() throws SQLException
    {
        TbUserPaymentplatformTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
