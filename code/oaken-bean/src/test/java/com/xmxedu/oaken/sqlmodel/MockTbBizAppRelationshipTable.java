...
public class MockTbBizAppRelationshipTable extends TbBizAppRelationshipTable.Implementation
{
    public static class Row extends TbBizAppRelationshipTable.Row
    {
    ...
    public TbBizAppRelationshipTable.Row getRow_return = null;
    public List getRow_returns = new ArrayList(); // use this instead of getRow_return for multiple calls

    public TbBizAppRelationshipTable.Row getRow(Connection con, long id)
    {
        getRow_con = con;
        getRow_id = id;
        TbBizAppRelationshipTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
            returnVal = (TbBizAppRelationshipTable.Row)getRow_returns.get(getRow_calls);
        }
        getRow_calls++;
        return returnVal;
    }

    public TbBizAppRelationshipTable.Row getRow(long id)
    {
        getRow_id = id;
        TbBizAppRelationshipTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
    ...
    public TbBizAppRelationshipTable.Row getRow()
    {
        TbBizAppRelationshipTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
    ...
    public TbBizAppRelationshipTable.Row getRow(Connection con, String column, String searchText) throws SQLException
    {
        getRow_con = con;
    ...
    public TbBizAppRelationshipTable.Row getRow(String column, String searchText) throws SQLException
    {
        getRow_column = column;
        getRow_searchText = searchText;
        TbBizAppRelationshipTable.Row returnVal = getRow_return;
    ...
    public TbBizAppRelationshipTable.Row[] getRows_return = null;
    public List getRows_returns = new ArrayList(); // use this instead of getRows_return for multiple calls

    public TbBizAppRelationshipTable.Row[] getRows(Connection con, String column, String searchText) throws SQLException
    {
        getRows_con = con;
        getRows_column = column;
        getRows_searchText = searchText;
        TbBizAppRelationshipTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
        {
            returnVal = (TbBizAppRelationshipTable.Row[])getRows_returns.get(getRows_calls);
        }
        getRows_calls++;
        return returnVal;
    }

    public TbBizAppRelationshipTable.Row[] getRows(String column, String searchText) throws SQLException
    {
        getRows_column = column;
        getRows_searchText = searchText;
        TbBizAppRelationshipTable.Row[] returnVal = getRows_return;
    ...
    public TbBizAppRelationshipTable.Row[] getRows(Connection con, String whereClause) throws SQLException
    {
        getRows_con = con;
    ...
    public TbBizAppRelationshipTable.Row[] getRows(String whereClause) throws SQLException
    {
        getRows_whereClause = whereClause;
        TbBizAppRelationshipTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
    ...
    public TbBizAppRelationshipTable.Row[] getAllRows_return = null;
    public List getAllRows_returns = new ArrayList(); // use this instead of getAllRows_return for multiple calls

    public TbBizAppRelationshipTable.Row[] getAllRows(Connection con) throws SQLException
    {
        getAllRows_con = con;
        TbBizAppRelationshipTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
            returnVal = (TbBizAppRelationshipTable.Row[])getAllRows_returns.get(getAllRows_calls);
        }
        getAllRows_calls++;
        return returnVal;
    }

    public TbBizAppRelationshipTable.Row[] getAllRows() throws SQLException
    {
        TbBizAppRelationshipTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
