...
public class MockTbAdTypeTable extends TbAdTypeTable.Implementation
{
    public static class Row extends TbAdTypeTable.Row
    {
    ...
    public TbAdTypeTable.Row getRow_return = null;
    public List getRow_returns = new ArrayList(); // use this instead of getRow_return for multiple calls

    public TbAdTypeTable.Row getRow(Connection con, long id)
    {
        getRow_con = con;
        getRow_id = id;
        TbAdTypeTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
            returnVal = (TbAdTypeTable.Row)getRow_returns.get(getRow_calls);
        }
        getRow_calls++;
        return returnVal;
    }

    public TbAdTypeTable.Row getRow(long id)
    {
        getRow_id = id;
        TbAdTypeTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
    ...
    public TbAdTypeTable.Row getRow()
    {
        TbAdTypeTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
    ...
    public TbAdTypeTable.Row getRow(Connection con, String column, String searchText) throws SQLException
    {
        getRow_con = con;
    ...
    public TbAdTypeTable.Row getRow(String column, String searchText) throws SQLException
    {
        getRow_column = column;
        getRow_searchText = searchText;
        TbAdTypeTable.Row returnVal = getRow_return;
    ...
    public TbAdTypeTable.Row[] getRows_return = null;
    public List getRows_returns = new ArrayList(); // use this instead of getRows_return for multiple calls

    public TbAdTypeTable.Row[] getRows(Connection con, String column, String searchText) throws SQLException
    {
        getRows_con = con;
        getRows_column = column;
        getRows_searchText = searchText;
        TbAdTypeTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
        {
            returnVal = (TbAdTypeTable.Row[])getRows_returns.get(getRows_calls);
        }
        getRows_calls++;
        return returnVal;
    }

    public TbAdTypeTable.Row[] getRows(String column, String searchText) throws SQLException
    {
        getRows_column = column;
        getRows_searchText = searchText;
        TbAdTypeTable.Row[] returnVal = getRows_return;
    ...
    public TbAdTypeTable.Row[] getRows(Connection con, String whereClause) throws SQLException
    {
        getRows_con = con;
    ...
    public TbAdTypeTable.Row[] getRows(String whereClause) throws SQLException
    {
        getRows_whereClause = whereClause;
        TbAdTypeTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
    ...
    public TbAdTypeTable.Row[] getAllRows_return = null;
    public List getAllRows_returns = new ArrayList(); // use this instead of getAllRows_return for multiple calls

    public TbAdTypeTable.Row[] getAllRows(Connection con) throws SQLException
    {
        getAllRows_con = con;
        TbAdTypeTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
            returnVal = (TbAdTypeTable.Row[])getAllRows_returns.get(getAllRows_calls);
        }
        getAllRows_calls++;
        return returnVal;
    }

    public TbAdTypeTable.Row[] getAllRows() throws SQLException
    {
        TbAdTypeTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
