...
public class MockTbBizAppCategoryTable extends TbBizAppCategoryTable.Implementation
{
    public static class Row extends TbBizAppCategoryTable.Row
    {
    ...
    public TbBizAppCategoryTable.Row getRow_return = null;
    public List getRow_returns = new ArrayList(); // use this instead of getRow_return for multiple calls

    public TbBizAppCategoryTable.Row getRow(Connection con, long id)
    {
        getRow_con = con;
        getRow_id = id;
        TbBizAppCategoryTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
            returnVal = (TbBizAppCategoryTable.Row)getRow_returns.get(getRow_calls);
        }
        getRow_calls++;
        return returnVal;
    }

    public TbBizAppCategoryTable.Row getRow(long id)
    {
        getRow_id = id;
        TbBizAppCategoryTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
    ...
    public TbBizAppCategoryTable.Row getRow()
    {
        TbBizAppCategoryTable.Row returnVal = getRow_return;
        if ((returnVal == null) && (getRow_calls < getRow_returns.size()))
        {
    ...
    public TbBizAppCategoryTable.Row getRow(Connection con, String column, String searchText) throws SQLException
    {
        getRow_con = con;
    ...
    public TbBizAppCategoryTable.Row getRow(String column, String searchText) throws SQLException
    {
        getRow_column = column;
        getRow_searchText = searchText;
        TbBizAppCategoryTable.Row returnVal = getRow_return;
    ...
    public TbBizAppCategoryTable.Row[] getRows_return = null;
    public List getRows_returns = new ArrayList(); // use this instead of getRows_return for multiple calls

    public TbBizAppCategoryTable.Row[] getRows(Connection con, String column, String searchText) throws SQLException
    {
        getRows_con = con;
        getRows_column = column;
        getRows_searchText = searchText;
        TbBizAppCategoryTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
        {
            returnVal = (TbBizAppCategoryTable.Row[])getRows_returns.get(getRows_calls);
        }
        getRows_calls++;
        return returnVal;
    }

    public TbBizAppCategoryTable.Row[] getRows(String column, String searchText) throws SQLException
    {
        getRows_column = column;
        getRows_searchText = searchText;
        TbBizAppCategoryTable.Row[] returnVal = getRows_return;
    ...
    public TbBizAppCategoryTable.Row[] getRows(Connection con, String whereClause) throws SQLException
    {
        getRows_con = con;
    ...
    public TbBizAppCategoryTable.Row[] getRows(String whereClause) throws SQLException
    {
        getRows_whereClause = whereClause;
        TbBizAppCategoryTable.Row[] returnVal = getRows_return;
        if ((returnVal == null) && (getRows_calls < getRows_returns.size()))
    ...
    public TbBizAppCategoryTable.Row[] getAllRows_return = null;
    public List getAllRows_returns = new ArrayList(); // use this instead of getAllRows_return for multiple calls

    public TbBizAppCategoryTable.Row[] getAllRows(Connection con) throws SQLException
    {
        getAllRows_con = con;
        TbBizAppCategoryTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
            returnVal = (TbBizAppCategoryTable.Row[])getAllRows_returns.get(getAllRows_calls);
        }
        getAllRows_calls++;
        return returnVal;
    }

    public TbBizAppCategoryTable.Row[] getAllRows() throws SQLException
    {
        TbBizAppCategoryTable.Row[] returnVal = getAllRows_return;
        if ((returnVal == null) && (getAllRows_calls < getAllRows_returns.size()))
        {
