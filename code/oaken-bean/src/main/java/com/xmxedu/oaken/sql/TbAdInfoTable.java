...
/** Strongly typed access to the database table "tb_ad_info".
 *
...
public class TbAdInfoTable
{
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbAdInfoTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbAdInfoTable.Implementation instance)
    {
        imp = instance;
    }
