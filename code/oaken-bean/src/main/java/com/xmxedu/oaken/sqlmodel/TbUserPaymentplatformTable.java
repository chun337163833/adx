...
/** Strongly typed access to the database table "tb_user_paymentplatform".
 *
 ...
 *
 */
public class TbUserPaymentplatformTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_user_paymentplatform";
    public static final String idColumnName = "id";
    public static final String paymentplatformidColumnName = "paymentplatformid";
    public static final String paymentplatformaccountColumnName = "paymentplatformaccount";
    private static String[] allColumns =
    {
        idColumnName, paymentplatformidColumnName, paymentplatformaccountColumnName
    };
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbUserPaymentplatformTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbUserPaymentplatformTable.Implementation instance)
    {
        imp = instance;
    }
    ...
    public static class Row
    {
        ...
        private Row(String[] data)
        {
            if (data != null)
            {
                ...
                this.paymentplatformid = Integer.parseInt(data[1]);
                this.paymentplatformaccount = data[2];
        ...
        private Map buildDataMap()
        {
            ...
            data.put(paymentplatformidColumnName, String.valueOf(this.paymentplatformid));
            data.put(paymentplatformaccountColumnName, this.paymentplatformaccount);
            return data;
        }
