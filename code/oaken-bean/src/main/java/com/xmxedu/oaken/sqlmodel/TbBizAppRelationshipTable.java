...
/** Strongly typed access to the database table "tb_biz_app_relationship".
 *
 ...
 *
 */
public class TbBizAppRelationshipTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_biz_app_relationship";
    public static final String idColumnName = "id";
    public static final String ouradColumnName = "ourad";
    public static final String otherplatformadColumnName = "otherplatformad";
    public static final String requestweightColumnName = "requestweight";
    private static String[] allColumns =
    {
        idColumnName, ouradColumnName, otherplatformadColumnName, requestweightColumnName
    };
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbBizAppRelationshipTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbBizAppRelationshipTable.Implementation instance)
    {
        imp = instance;
    }
    ...
    public static class Row
    {
        ...
        private int ourad;
        private boolean ouradNull = true;
        private int otherplatformad;
        private boolean otherplatformadNull = true;
        private double requestweight;
        private boolean requestweightNull = true;
        ...
        private Row(String[] data)
        {
            if (data != null)
            {
                ...
                this.ouradNull = (data[1] == null);
                this.ourad = ouradNull ? 0 : Integer.parseInt(data[1]);
                this.otherplatformadNull = (data[2] == null);
                this.otherplatformad = otherplatformadNull ? 0 : Integer.parseInt(data[2]);
                this.requestweightNull = (data[3] == null);
                this.requestweight = requestweightNull ? 0.0 : Double.parseDouble(data[3]);
        ...
        public void setOurad(int ourad)
        {
            this.ourad = ourad;
            ouradNull = false;
        }

        public void setOurad(Integer ourad)
        {
            ouradNull = (ourad == null);
            if (ouradNull)
            {
                this.ourad = 0;
            }
            ...
            {
                this.ourad = ourad.intValue();
            }
        }

        public boolean isOuradNull()
        {
            return ouradNull;
        }

        public void setOuradNull(boolean ouradNull)
        {
            this.ouradNull = ouradNull;
            if (ouradNull)
            {
                ourad = 0;
            }
        ...
        public int getOtherplatformad()
        {
            return otherplatformad;
        }

        public void setOtherplatformad(int otherplatformad)
        {
            this.otherplatformad = otherplatformad;
            otherplatformadNull = false;
        }

        public void setOtherplatformad(Integer otherplatformad)
        {
            otherplatformadNull = (otherplatformad == null);
            if (otherplatformadNull)
            {
                this.otherplatformad = 0;
            }
            else
            {
                this.otherplatformad = otherplatformad.intValue();
            }
        }

        public boolean isOtherplatformadNull()
        {
            return otherplatformadNull;
        }

        public void setOtherplatformadNull(boolean otherplatformadNull)
        {
            this.otherplatformadNull = otherplatformadNull;
            if (otherplatformadNull)
            {
                otherplatformad = 0;
            }
        ...
        public void setRequestweight(double requestweight)
        {
            ...
            requestweightNull = false;
        }

        public void setRequestweight(Double requestweight)
        {
            requestweightNull = (requestweight == null);
            if (requestweightNull)
            {
                this.requestweight = 0.0;
            }
            else
            {
                this.requestweight = requestweight.doubleValue();
            }
        }

        public boolean isRequestweightNull()
        {
            return requestweightNull;
        }

        public void setRequestweightNull(boolean requestweightNull)
        {
            this.requestweightNull = requestweightNull;
            if (requestweightNull)
            {
                requestweight = 0.0;
            }
        ...
        private Map buildDataMap()
        {
            ...
            data.put(ouradColumnName, this.ouradNull ? null : String.valueOf(this.ourad));
            data.put(otherplatformadColumnName, this.otherplatformadNull ? null : String.valueOf(this.otherplatformad));
            data.put(requestweightColumnName, this.requestweightNull ? null : String.valueOf(this.requestweight));
            return data;
        }
