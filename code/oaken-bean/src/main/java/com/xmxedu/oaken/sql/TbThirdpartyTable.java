...
/** Strongly typed access to the database table "tb_thirdparty".
 *
 ...
 *
 */
public class TbThirdpartyTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_thirdparty";
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbThirdpartyTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbThirdpartyTable.Implementation instance)
    {
        imp = instance;
    }
