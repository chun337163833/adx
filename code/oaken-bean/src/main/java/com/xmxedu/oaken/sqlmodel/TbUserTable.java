...
/** Strongly typed access to the database table "tb_user".
 *
...
public class TbUserTable
{
    ...
    public static final String realnameColumnName = "realname";
    public static final String phoneColumnName = "phone";
    public static final String qqColumnName = "qq";
    public static final String identityaccountColumnName = "identityaccount";
    public static final String identitypictureColumnName = "identitypicture";
    public static final String regisgertimeColumnName = "regisgertime";
    private static String[] allColumns =
    {
        idColumnName, nicknameColumnName, passwordColumnName, statusColumnName, realnameColumnName, phoneColumnName, qqColumnName, identityaccountColumnName, identitypictureColumnName, regisgertimeColumnName
    };
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbUserTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbUserTable.Implementation instance)
    {
        imp = instance;
    }
    ...
    public static class Row
    {
        ...
        private int regisgertime;
        private boolean regisgertimeNull = true;
        ...
        private Row(String[] data)
        {
            if (data != null)
            {
                ...
                this.realname = data[4];
                this.phone = data[5];
                this.qq = data[6];
                this.identityaccount = data[7];
                this.identitypicture = data[8];
                this.regisgertimeNull = (data[9] == null);
                this.regisgertime = regisgertimeNull ? 0 : Integer.parseInt(data[9]);
        ...
        public int getRegisgertime()
        {
            return regisgertime;
        }

        public void setRegisgertime(int regisgertime)
        {
            this.regisgertime = regisgertime;
            regisgertimeNull = false;
        }

        public void setRegisgertime(Integer regisgertime)
        {
            regisgertimeNull = (regisgertime == null);
            if (regisgertimeNull)
            {
                this.regisgertime = 0;
            }
            ...
            {
                this.regisgertime = regisgertime.intValue();
            }
        }

        public boolean isRegisgertimeNull()
        {
            return regisgertimeNull;
        }

        public void setRegisgertimeNull(boolean regisgertimeNull)
        {
            this.regisgertimeNull = regisgertimeNull;
            if (regisgertimeNull)
            {
                regisgertime = 0;
            }
        ...
        private Map buildDataMap()
        {
            ...
            data.put(nicknameColumnName, this.nickname);
            data.put(passwordColumnName, this.password);
            data.put(statusColumnName, this.statusNull ? null : String.valueOf(this.status));
            data.put(realnameColumnName, this.realname);
            data.put(phoneColumnName, this.phone);
            data.put(qqColumnName, this.qq);
            data.put(identityaccountColumnName, this.identityaccount);
            data.put(identitypictureColumnName, this.identitypicture);
            data.put(regisgertimeColumnName, this.regisgertimeNull ? null : String.valueOf(this.regisgertime));
            return data;
        }
