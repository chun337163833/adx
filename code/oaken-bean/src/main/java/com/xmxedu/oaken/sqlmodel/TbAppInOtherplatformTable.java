...
/** Strongly typed access to the database table "tb_app_in_otherplatform".
 *
 ...
 *
 */
public class TbAppInOtherplatformTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_app_in_otherplatform";
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbAppInOtherplatformTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbAppInOtherplatformTable.Implementation instance)
    {
        imp = instance;
    }
