...
/** Strongly typed access to the database table "tb_biz_app_category".
 *
 ...
 *
 */
public class TbBizAppCategoryTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_biz_app_category";
    ...
    {
        idColumnName, appidColumnName, categoryidColumnName, statusColumnName
    };
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbBizAppCategoryTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbBizAppCategoryTable.Implementation instance)
    {
        imp = instance;
    }
    ...
    public static class Row
    {
        ...
        private Row(String[] data)
        {
            if (data != null)
            {
                ...
                this.appid = Integer.parseInt(data[1]);
                this.categoryid = Integer.parseInt(data[2]);
        ...
        private Map buildDataMap()
        {
            ...
            data.put(statusColumnName, String.valueOf(this.status));
            return data;
        }
