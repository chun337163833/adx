...
/** Strongly typed access to the database table "tb_ad_type".
 *
...
public class TbAdTypeTable
{
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbAdTypeTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbAdTypeTable.Implementation instance)
    {
        imp = instance;
    }
