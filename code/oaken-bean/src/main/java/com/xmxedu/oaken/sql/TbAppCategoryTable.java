...
/** Strongly typed access to the database table "tb_app_category".
 *
 ...
 *
 */
public class TbAppCategoryTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_app_category";
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbAppCategoryTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbAppCategoryTable.Implementation instance)
    {
        imp = instance;
    }
