...
public class SQLFacade
{
    ...
    public static class Implementation extends DBFacade
    {
        Implementation()
        {
            super("com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/adx");
     ...
     *
     * @throws Exception The types of exceptions thrown here can change depending on the type of database access.
     */
