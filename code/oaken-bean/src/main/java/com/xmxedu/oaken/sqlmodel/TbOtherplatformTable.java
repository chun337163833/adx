...
/** Strongly typed access to the database table "tb_otherplatform".
 *
 ...
 *
 */
public class TbOtherplatformTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_otherplatform";
    public static final String idColumnName = "id";
    public static final String nameColumnName = "name";
    public static final String requesttypeColumnName = "requesttype";
    public static final String platformtypeColumnName = "platformtype";
    public static final String requesturlColumnName = "requesturl";
    public static final String keyColumnName = "key";
    public static final String tokenColumnName = "token";
    private static String[] allColumns =
    {
        idColumnName, nameColumnName, requesttypeColumnName, platformtypeColumnName, requesturlColumnName, keyColumnName, tokenColumnName
    };
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbOtherplatformTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbOtherplatformTable.Implementation instance)
    {
        imp = instance;
    }
    ...
    public static class Row
    {
        ...
        private Row(String[] data)
        {
            if (data != null)
            {
                ...
                this.name = data[1];
                this.requesttype = Integer.parseInt(data[2]);
                this.platformtype = Integer.parseInt(data[3]);
                this.requesturl = data[4];
                this.key = data[5];
                this.token = data[6];
        ...
        private Map buildDataMap()
        {
            ...
            data.put(requesttypeColumnName, String.valueOf(this.requesttype));
            data.put(platformtypeColumnName, String.valueOf(this.platformtype));
            data.put(requesturlColumnName, this.requesturl);
            data.put(keyColumnName, this.key);
            data.put(tokenColumnName, this.token);
            return data;
        }
