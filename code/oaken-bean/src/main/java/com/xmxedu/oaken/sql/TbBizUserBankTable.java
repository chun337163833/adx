...
/** Strongly typed access to the database table "tb_biz_user_bank".
 *
 ...
 *
 */
public class TbBizUserBankTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_biz_user_bank";
    public static final String idColumnName = "id";
    public static final String useridColumnName = "userid";
    public static final String paymentwayColumnName = "paymentway";
    public static final String paymentidColumnName = "paymentid";
    public static final String statusColumnName = "status";
    private static String[] allColumns =
    {
        idColumnName, useridColumnName, paymentwayColumnName, paymentidColumnName, statusColumnName
    };
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbBizUserBankTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbBizUserBankTable.Implementation instance)
    {
        imp = instance;
    }
    ...
    public static class Row
    {
        ...
        private Row(String[] data)
        {
            if (data != null)
            {
                ...
                this.paymentway = Integer.parseInt(data[2]);
                this.paymentid = Integer.parseInt(data[3]);
                this.statusNull = (data[4] == null);
                this.status = statusNull ? 0 : Integer.parseInt(data[4]);
        ...
        private Map buildDataMap()
        {
            ...
            data.put(paymentwayColumnName, String.valueOf(this.paymentway));
            data.put(paymentidColumnName, String.valueOf(this.paymentid));
