...
/** Strongly typed access to the database table "tb_paymentplatform".
 *
 ...
 *
 */
public class TbPaymentplatformTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_paymentplatform";
    public static final String idColumnName = "id";
    public static final String paymentplatformnameColumnName = "paymentplatformname";
    private static String[] allColumns =
    {
        idColumnName, paymentplatformnameColumnName
    };
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbPaymentplatformTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbPaymentplatformTable.Implementation instance)
    {
        imp = instance;
    }
    ...
    public static class Row
    {
        ...
        private Row(String[] data)
        {
            if (data != null)
            {
                ...
                this.paymentplatformname = data[1];
        ...
        private Map buildDataMap()
        {
            ...
            data.put(paymentplatformnameColumnName, this.paymentplatformname);
            return data;
        }
