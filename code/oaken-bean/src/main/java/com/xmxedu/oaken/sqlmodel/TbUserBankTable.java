...
/** Strongly typed access to the database table "tb_user_bank".
 *
 ...
 *
 */
public class TbUserBankTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_user_bank";
    public static final String idColumnName = "id";
    public static final String banknameColumnName = "bankname";
    public static final String bankaddressColumnName = "bankaddress";
    public static final String bankaccountColumnName = "bankaccount";
    private static String[] allColumns =
    {
        idColumnName, banknameColumnName, bankaddressColumnName, bankaccountColumnName
    };
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbUserBankTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbUserBankTable.Implementation instance)
    {
        imp = instance;
    }
    ...
    public static class Row
    {
        ...
        private Row(String[] data)
        {
            if (data != null)
            {
                ...
                this.bankaddress = data[2];
                this.bankaccount = data[3];
        ...
        private Map buildDataMap()
        {
            ...
            data.put(banknameColumnName, this.bankname);
            data.put(bankaddressColumnName, this.bankaddress);
            data.put(bankaccountColumnName, this.bankaccount);
            return data;
        }
