...
/** Strongly typed access to the database table "tb_biz_app_ad".
 *
 ...
 *
 */
public class TbBizAppAdTable
{
    private static Implementation imp = new Implementation();
    public static final String tableName = "tb_biz_app_ad";
    ...
    {
        idColumnName, appidColumnName, adidColumnName, statusColumnName
    };
     ...
     *  you wanted to.
     *
     *  To use this in your unit testing, create an instance of MockTbBizAppAdTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance(TbBizAppAdTable.Implementation instance)
    {
        imp = instance;
    }
